...
<section @class([ 'section',
   ...
   >
      <div class="row justify-content-center">
         <div class="col-lg-6 col-md-6 col-12" id="contact-form">
            <div class="custom-form rounded mb-5 mb-lg-0 bg-light p-5" data-aos="zoom-up" data-aos-duration="1800" data-aos-delay="500">
                     ...
                     <div class="d-flex w-100 mb-5" data-aos="fade-up" data-aos-duration="1800" data-aos-delay="1000">
                        <div class="features feature-primary border-0 d-flex h-100">
                           ...
                           <div class="content flex-1 ms-3">
                              ...
                              <div class="mt-2 content-text">{{ $company->physical_address }}</div>
                           </div>
                        </div>
                     </div>
                  @endif
