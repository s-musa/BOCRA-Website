<section class="bg-home-2 align-content-center hero-slide" id="home" style="max-height: 777px; min-height: 700px; background:linear-gradient(to right, #000000, transparent, transparent, transparent), url({{ $section->media[0]->original_url ?? asset('dummy-image.jpg') }}) no-repeat center / cover;">
   <div class="video-section" >
      <video class="hero-video" autoplay muted loop playsinline
{{--         poster="{{ $section->media[0]->original_url ?? asset('dummy-image.jpg') }}"--}}
      >
         <source src="{{ $section->video_url ?? asset('videos/four-bedroom-video.mp4') }}" type="video/mp4">
   ...
   >
      <div class="row">
         <div class="col-lg-7 hero-mt-100">
            <div class="section-title text-start text-white">
