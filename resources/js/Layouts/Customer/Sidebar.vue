<template>
   <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme ">
      ...
      <ul class="menu-inner py-1">
         <!-- Dashboard -->
         <li :class="{ 'menu-item': true, 'active': $page.url.startsWith('/customer/dashboard') }">
            <Link :href="route('customer.dashboard')" class="menu-link">
            <span>
         ...
         <li :class="{ 'menu-item': true, 'active': $page.url.startsWith('/customer/orders') }">
            <Link :href="route('customer.orders.index')" class="menu-link">
            <span>
